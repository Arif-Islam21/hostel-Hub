  ...
  return (
    <div className="flex justify-between gap-4 group border-2 border-gray-200 shadow-lg rounded-lg p-2">
      <div className="relative">
        ...
        <div className="absolute size-20 bg-themeColor/40 group-hover:flex hidden duration-300 transition-all z-10 rounded-full top-0 left-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl text-white font-bold">
            <IoCartOutline />
          </div>
        </div>
      </div>
      <div className="min-w-fit flex flex-grow flex-col justify-center">
